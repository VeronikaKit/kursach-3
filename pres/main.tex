...
\begin{frame}{Примеры сгенерированных задач (шаблон 26586.js)}
    ...
    \begin{columns}[T]
        ...
        \begin{exampleblock}{Байдарка}
            96 км против течения, обратно на 4 ч быстрее, течение 1 км/ч.\\
            \textbf{Скорость в неподвижной воде?} \textbf{7 км/ч}
        \end{exampleblock}
        \column{0.48\textwidth}
        \begin{exampleblock}{Яхта}
            140 км против течения, обратно на 8 ч быстрее, течение 1 км/ч.\\
            \textbf{Скорость в неподвижной воде?} \textbf{6 км/ч}
        \end{exampleblock}
    \end{columns}
    \vfill
    \centering
    \fbox{Один шаблон → тысячи уникальных задач}
\end{frame}
