...
\begin{frame}{Примеры сгенерированных задач (шаблон 26586.js)}
    ...
    \begin{exampleblock}{Вариант 1 (байдарка)}
        Байдарка прошла против течения реки 96 км и вернулась в пункт отправления,
        затратив на обратный путь на 4 часа меньше.\\
        Скорость течения равна 1 км/ч.\\
        \textbf{Определите скорость байдарки в неподвижной воде.}
        \vspace{2mm}
    ...
    \begin{exampleblock}{Вариант 2 (яхта)}
        Яхта прошла против течения реки 140 км и вернулась в пункт отправления,
        затратив на обратный путь на 8 часов меньше.\\
        Скорость течения равна 1 км/ч.\\
        \textbf{Найдите скорость яхты в неподвижной воде.}
        \vspace{2mm}
